...
DROP FUNCTION IF EXISTS refresh_proposal_monthly_costs(uuid);
DROP FUNCTION IF EXISTS handle_circuit_changes();
DROP FUNCTION IF EXISTS handle_proposal_circuit_changes();
